...
<style>
  input[type="checkbox"] {
    ...
    .extra-bed-textbox {
        margin-bottom: 15px; /* Adjust the spacing between textboxes */
    }
</style>
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form action="{{ isset($roomtype) ? '/roomtype/update/' . $roomtype->id : '/roomtype/store' }}" method="POST"  enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>RoomType Name</label>
                                        <input type="text" class="form-control @error('room_name') is-invalid @enderror" name="room_name" value="{{ old('room_name', $roomtype->room_name ?? '') }}">
                                    @error('room_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Capacity</label>
                                        <input type="number" class="form-control @error('capacity') is-invalid @enderror" name="capacity" value="{{ old('capacity', $roomtype->capacity ?? '') }}">
                                    @error('capacity')
                                        <div class="error text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Extra Base Price</label>
                                        <input readonly type="number" class="form-control @error('extra_bed_price') is-invalid @enderror" id="total_base_price" name="extra_bed_price">
