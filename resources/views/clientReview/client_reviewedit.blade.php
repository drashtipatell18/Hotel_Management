        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title mt-5">Edit Clent Review</h3>
                    </div>
                </div>
            </div>
            <form action="{{ route('clientReview/update', $clientReviewList->id ) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row formtype">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('client_name') is-invalid @enderror" name="client_name" value="{{ $clientReviewList->client_name }}">
                                    @error('client_name')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <a href="#">
                                                <img id="profilePicPreview" class="avatar-img square" style="width:100px; height:100px; padding:20px;" src="{{ URL::to('/assets/upload/'.$clientReviewList->image) }}" alt="{{ $clientReviewList->image }}">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="4">{{ $clientReviewList->description }}</textarea>
                                    @error('description')
                ...
                <a href="{{ route('clientReview/list') }}"  type="submit" class="btn btn-secondary  padding:10px" style="float:right !important;margin-right:10px !important; padding:10px !important">Back</a>
            </form>
        </div>
    </div>
...
var currentCountry = "{{ $currentCountry }}"; // Replace with your actual variable
var currentState = "{{ $currentState }}"; // Replace with your actual variable

populateCountries("country", "state", currentCountry, currentState);
});
</script>
