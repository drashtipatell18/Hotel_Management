...
@section('title', 'Hotel Management: Checkout')
                    ...
                    <div class="d_inquiry">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" placeholder="First Name*" id="" name="first_name"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="tel" placeholder="Phone*" name="phone" id=""
            ...
            <div class="d_box">
                <div class="row g-3">
                    <div class="col-12 col-xl-5">
                        <div class="d_img">
                            <div class="d_img">
                                ...
                                <img src="{{ asset('assets/upload/' . $booking->room->images->first()->image) }}"
                                    alt="{{ $booking->room->name }}" class="img-fluid">
                                @else
                                <img src="{{ asset('assets/upload/default.jpg') }}" alt="Default Image"
                                    class="img-fluid">
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-xl-7">
                        ...
                        <p><span>Check in :</span> {{ \Carbon\Carbon::parse($booking->check_in_date)->format('d/m/Y') }}
                        </p>
                ...
                <div class="row">
                    ...
                    <div class="col-6 d-block">
                        <div class="d_cta h-100 d-block">
                            <button type="submit"
                                class="d-flex w-100 justify-content-center h-100 align-items-center coupon-btn">Apply</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script>
    $(document).ready(function() {
        ...
        // Custom method for validating coupon code
        $.validator.addMethod("validCoupon", function(value, element) {
            // Here you can add your logic to check if the coupon code is valid
            // For example, you can make an AJAX call to validate the coupon code
