...
@section('title', 'Hotel Management: Room BookNow')
@section('main-container')
    ...
    <section class="d_booknow">
        <div class="d_img col">
            ...
            <img src="{{ url('assets/upload/' . $room->room_image) }}" alt="{{ $room->room_name }}">
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let memberCount = 1;
            const pricePerRoom = {{ $room->base_price ?? 0 }}; // Price for one room
