...
<section class="d_p-25">
    <div class="d_heading2">
...
<section class="d_p-25 d_form pt-0">
    <div class="d_container">
        <div class="row g-4 d_formspace">
            <div class="col-12 col-lg-7 p-sm-4 mt-0">
                <form action="{{ route('spacheckout.store', $spaBookknow->id) }}" method="post" id="checkoutform">
                    @csrf
                    <div class="d_inquiry">
                        <div class="row mb-3">
                            <div class="col-12">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="email" placeholder="Email*" name="email" id="" value="{{ old('email')}}">
                            </div>
                            <div class="col-12 col-md-6">
                                <label for="dob">Nationality</label>
                                <input type="text" placeholder="Nationality*" name="nationality" id=""
                    ...
                    <div class="d_inquiry">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <textarea type="text" placeholder="Additional Message" name="additional_info" id=""
                                    rows="7">{{ old('additional_info') }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="d_inquiry">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="d_paymentimg">
                                        <svg width="40" height="30" viewBox="0 0 40 30" fill="none"
                                            ...
                                            <rect x="0.166667" y="0.166667" width="39.6667" height="29.6667"
                                                rx="1.16667" fill="white" stroke="#D9D9D9" stroke-width="0.333333" />
                                        ...
                                        <svg width="40" height="30" viewBox="0 0 40 30" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <rect x="0.166667" y="0.166667" width="39.6667" height="29.6667"
                                                rx="1.16667" fill="#1F72CD" stroke="#D9D9D9" stroke-width="0.333333" />
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <div class="d_inquiry mt-2">
                        <div class="row">
                            <div class="col-12 text-center">
                                <div class="d_cta">
                                    <button type="submit" class="d-block d-sm-inline-block text-center">Confirm Your
                                        Stay</button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-5 p-sm-4 mt-0">
                <div class="d_book">
                    <div class="d_box">
                        <div class="row g-3">
                            <div class="col-12 col-xl-5 ">
                                <div class="d_img h-100">
                                    @if($firstImagePath)
                                        <img src="{{ url('assets/spa/' . $firstImagePath) }}" class="h-100" alt="">
                                    @else
                                        <img src="/img/d_img/default-image.png" class="h-100" alt="Default Image"> 
                                    @endif
                                </div>
                            </div>
                            <div class="col-12 col-xl-7">
                                <h2 class="d_spatext" style="color:white;font-size:27px">{{ $spaCategory }}</h2>
                                <p><span>Check-in Date:</span> {{ \Carbon\Carbon::parse($spaBookknow->checkin)->format('Y-m-d') }}</p> <!-- Format check-in date -->
                                <p><span>Check In Time :</span> {{ $spaBookknow->time}}</p>
                                <p><span>Person :</span> {{$spaBookknow->person}}</p>
                                <p><span>Technician :</span>{{ $spaBookknow->technician}}</p>
                            </div>
                        </div>
                    ...
                    <div class="d_box d_pricelist">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h3>Total</h3>
                            <h3>${{ $spaBookknow->total_price + 100 }}</h3>
                        </div>
                    </div>
                </div>
