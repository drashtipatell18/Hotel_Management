                    ...
                    <form action="{{ route('spacheckout.store') }}" method="post" id="checkoutform">
                        ...
                        <div class="d_inquiry">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="d-flex">
                                        <select name="" id="" class="m-0 w-auto">
                                            <option value="">+1</option>
                                            <option value="">+1</option>
                                            <option value="">+1</option>
                                            <option value="">+1</option>
                                        </select>
                                        <input type="number" placeholder="Phone*" class="rounded-top-0 rounded-bottom-0 "
                                            name="phone" id="">
                                    </div>
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-xl-5 ">
                                    <div class="d_img h-100">
                                        <img src="/img/d_img/spaper.png" class="h-100" alt="">
                                    </div>
                                </div>
                                <div class="col-12 col-xl-7">
                                    <h5>Custom Massage(100 min)</h5>
                                    <p><span>Date :</span> 07/08/24 at 9:00 am</p>
                                    <p><span>Check out :</span> 08/08/24 (1 Night)</p>
                                    <p><span>Person :</span> 01</p>
                                    <p><span>Technician :</span> Any Preference</p>
                                </div>
                            </div>
