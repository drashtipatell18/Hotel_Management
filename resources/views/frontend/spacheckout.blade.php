            ...
            <div class="row g-4 d_formspace" >
                <div class="col-12 col-lg-7 p-sm-4 mt-0">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="d-flex">
                                    ...
                                    <input type="text" placeholder="Phone*" class="rounded-top-0 rounded-bottom-0 "
                                        name="" id="">
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                <input type="text" placeholder="Nationality*" name="" id="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d_inquiry">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <textarea type="text" placeholder="Additional Message" name="" id=""
                                    rows="7"></textarea>
                            </div>
                        </div>
                    </div>
