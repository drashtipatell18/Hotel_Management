        ...
        <div class="content container-fluid">
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="mt-5">
                            <h4 class="card-title float-left mt-2">Hotel</h4> <a href="{{ route('hotel/add') }}"
                                class="btn btn-primary float-right veiwbutton"><i class="fas fa-plus mr-2"></i>Add Hotel</a>
                        </div>
                    </div>
                </div>
            </div>
